...
<aside class="admin-sidebar">
  <div style="padding:1rem 1.25rem; border-bottom:1px solid var(--border); margin-bottom:0.5rem;">
    <a href="/" style="display:flex;align-items:center;gap:0.5rem;">
      <img src="/assets/images/logo.png" alt="RedWater" style="height:32px;" data-img-error="hide-self">
  ...
  <a href="/admin/merch.php" class="admin-nav-link <?= $currentPage === 'merch.php' ? 'active' : '' ?>">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 2l1.5 4h9L18 2"/><path d="M3 6h18l-1.5 14h-15z"/><path d="M9 10v6"/><path d="M15 10v6"/></svg>
    Merch Store
  </a>
  ...
  <a href="/admin/volunteers.php" class="admin-nav-link <?= $currentPage === 'volunteers.php' ? 'active' : '' ?>">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 11h-6"/><path d="M20 8v6"/></svg>
    Volunteers
  </a>
